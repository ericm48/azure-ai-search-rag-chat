...
public class ApplicationConfiguration {
	...
	private String OPENAI_CHAT_DEPLOYMENT_NAME;

	@Value("${spring.ai.azure.openai.embedding.options.deployment-name}")
	private String OPENAI_EMBEDDING_DEPLOYMENT_NAME;
	...
	private void dumpConfig()
	{
		...
		logger.info("     OPENAI_CHAT_DEPLOYMENT_NAME: " + OPENAI_CHAT_DEPLOYMENT_NAME);
		logger.info("OPENAI_EMBEDDING_DEPLOYMENT_NAME: " + OPENAI_EMBEDDING_DEPLOYMENT_NAME);
